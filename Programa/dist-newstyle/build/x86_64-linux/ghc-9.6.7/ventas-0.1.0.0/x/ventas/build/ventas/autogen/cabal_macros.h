...
/* package ventas-0.1.0.0 */
#ifndef VERSION_ventas
#define VERSION_ventas "0.1.0.0"
#endif /* VERSION_ventas */
#ifndef MIN_VERSION_ventas
#define MIN_VERSION_ventas(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ventas */
...
#define CURRENT_COMPONENT_ID "ventas-0.1.0.0-inplace-ventas"
