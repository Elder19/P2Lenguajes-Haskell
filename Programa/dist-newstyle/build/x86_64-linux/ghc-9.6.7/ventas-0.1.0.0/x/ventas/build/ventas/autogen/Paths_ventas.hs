...
getDynLibDir  = catchIO (getEnv "ventas_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "ventas_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "ventas_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "ventas_sysconfdir") (\_ -> return sysconfdir)
